    ...
    NativeMetaTransaction
{
    ...
    */
    constructor(
        ...
        // EIP712 init
        _initializeEIP712("Moto Network Marketplace", "1");
    ...
    function getPublicationFee() public view returns (uint256) {
    ...
    function _createOrder(
        ...
        bytes32 orderId = keccak256(
            abi.encodePacked(block.timestamp, assetOwner, assetId, nftAddress)
        );
    ...
    function changePrice(
        ...
        order.price = price;
        orderByAssetId[nftAddress][assetId] = order;
        emit PriceChanged(order.id, nftAddress, assetId, sender, price);
        return order;
    }
    ...
    function _executeOrder(
        ...
        require(
            acceptedToken.transferFrom(sender, seller, price - saleShareAmount),
